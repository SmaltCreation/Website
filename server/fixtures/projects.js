...
projectsFixtures = [
    {
        ...
        slug: 'overiz',
        name: 'Overiz',
        description: 'project.overiz.description',
        img: '/images/project-overiz.png',
        thumbnail: '/images/project-overiz360x203.png',
        url: 'http://www.overiz.com',
        importance: 1,
        portfolio: true,
        contribution: false,
        draft: false,
        ...
        slug: 'beezsport',
        name: 'BeezSport',
        description: 'project.beezsport.description',
        img: '/images/project-beezsport.png',
        thumbnail: '/images/project-beezsport360x203.png',
        url: 'http://www.beezsport.com',
        importance: 2,
        portfolio: true,
        contribution: false,
        draft: false,
